...
public class FirebaseAuthManager : Singleton<FirebaseAuthManager>
{
    ...
    public void SetInputUi(Button loginBtn, Button registerBtn, TMP_InputField emailInput, TMP_InputField passwordInput, TMP_InputField nickInput)
    {
        loginButton = loginBtn;
        registerButton = registerBtn;
        emailField = emailInput;
        pwField = passwordInput;
        nickField = nickInput;
        Init();
    }
}

...
public class PlayerMoveState : PlayerStateBase
{
    ...
    public override void FixedExecute()
    {
        ...
        if (input.sqrMagnitude < 0.01f)
        {
            ...
            Vector3 newHorizontal = Vector3.Lerp(new Vector3(currentVel.x, 0, currentVel.z), Vector3.zero, Time.fixedDeltaTime * 10f);

            player.Rigidbody.linearVelocity = new Vector3(newHorizontal.x, currentVel.y, newHorizontal.z);
